	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000119000)(name:"keepdims" type:INT i:1 )
		   }
		   ,
		   },
		...
		*/
		...
		ExpectedOutput: []tensor.Tensor{
			...
			tensor.New(
				...
				tensor.WithBacking([]float32{14.970192}),
			),
		},
	}
}
