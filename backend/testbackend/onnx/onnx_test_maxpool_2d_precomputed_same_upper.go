	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000126600)(name:"auto_pad" type:STRING s:"SAME_UPPER" ),
		    (*ir.AttributeProto)(0xc000126700)(name:"kernel_shape" type:INTS ints:3 ints:3 ),
		    (*ir.AttributeProto)(0xc000126800)(name:"strides" type:INTS ints:2 ints:2 )
		   }
		   ,
		   },
		...
		*/
		...
		ExpectedOutput: []tensor.Tensor{
			...
			tensor.New(
				...
				tensor.WithBacking([]float32{7, 9, 10, 17, 19, 20, 22, 24, 25}),
			),
		},
	}
}
