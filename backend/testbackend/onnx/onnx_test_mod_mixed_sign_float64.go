...
func init() {
	testbackend.Register("Mod", "TestModMixedSignFloat64", NewTestModMixedSignFloat64)
}
	...
	return &testbackend.TestCase{
		...
		*/
		...
		Input: []tensor.Tensor{
			...
			tensor.New(
				tensor.WithShape(6),
				tensor.WithBacking([]float64{-4.3, 7.2, 5, 4.3, -7.2, 8}),
			),

			tensor.New(
				tensor.WithShape(6),
				tensor.WithBacking([]float64{2.1, -3.4, 8, -2.1, 3.4, 5}),
			),
		},
		ExpectedOutput: []tensor.Tensor{
			...
			tensor.New(
				tensor.WithShape(6),
				tensor.WithBacking([]float64{-0.09999999999999964, 0.40000000000000036, 5, 0.09999999999999964, -0.40000000000000036, 3}),
			),
		},
	}
}
