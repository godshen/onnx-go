	...
	return &testbackend.TestCase{
		...
		*/
		...
		ExpectedOutput: []tensor.Tensor{
			...
			tensor.New(
				tensor.WithShape(7),
				tensor.WithBacking([]float32{0, 0, 0, 0, 1, 1, 1}),
			),
		},
	}
}
