...
func init() {
	testbackend.Register("NonMaxSuppression", "TestNonmaxsuppressionSingleBox", NewTestNonmaxsuppressionSingleBox)
}
...
func NewTestNonmaxsuppressionSingleBox() *testbackend.TestCase {
	return &testbackend.TestCase{
		...
		Title:  "TestNonmaxsuppressionSingleBox",
		...
		*/
		...
		Input: []tensor.Tensor{
			...
			tensor.New(
				tensor.WithShape(1, 1, 4),
				tensor.WithBacking([]float32{0, 0, 1, 1}),
			),

			tensor.New(
				tensor.WithShape(1, 1, 1),
				tensor.WithBacking([]float32{0.9}),
			),
