	...
	return &testbackend.TestCase{
		...
		*/
		...
		ExpectedOutput: []tensor.Tensor{
			...
			tensor.New(
				tensor.WithShape(3),
				tensor.WithBacking([]int64{3, 4, 5}),
			),
		},
	}
}
